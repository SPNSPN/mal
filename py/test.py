...
CHECK("(queue)", "/()/")
CHECK("(queue 1 2 3)", "/(1 2 3)/")
CHECK("(pushqueue (pushqueue (pushqueue (queue) 5) 1) 0)", "/(5 1 0)/")
CHECK("(popqueue (pushqueue (pushqueue (pushqueue (queue) 5) 1) 0))", "5")
CHECK("(to-list \"hello\")", "(104 101 108 108 111)")
CHECK("(to-list 'hello)", "(104 101 108 108 111)")
CHECK("(to-list [1 2 3 4])", "(1 2 3 4)")
CHECK("(define queu (queue)) (pushqueue queu 1) (pushqueue queu 2) (pushqueue queu 3) (pushqueue queu 4) (to-list queu)", "(1 2 3 4)")
CHECK("(to-list nil)", "NIL")
CHECK("(to-vect '(1 2 3 4))", "[1 2 3 4]")
CHECK("(to-vect \"hello\")", "[104 101 108 108 111]")
CHECK("(to-vect 'hello)", "[104 101 108 108 111]")
CHECK("(to-vect (pushqueue (pushqueue (pushqueue (queue) 5) 1) 0))", "[5 1 0]")
CHECK("(to-vect nil)", "[]")
CHECK("(to-queue (list 1 2 3 4))", "/(1 2 3 4)/")
CHECK("(to-queue [1 2 3 4])", "/(1 2 3 4)/")
CHECK("(to-queue \"hello\")", "/(104 101 108 108 111)/")
CHECK("(to-queue 'hello)", "/(104 101 108 108 111)/")
CHECK("(to-queue nil)", "/()/")
CHECK("(symbol '(104 101 108 108 111))", "hello")
CHECK("(symbol \"abcd\")", "abcd")
CHECK("(symbol [104 101 108 108 111])", "hello")
CHECK("(symbol (pushqueue (pushqueue (pushqueue (queue) 97) 98) 99))", "abc")
...
CHECK("(load \"lisp/test.mal\")", "NIL")

CHECK("(and t t (> 2 1) t)", "T")
CHECK("(and t nil (> 2 1) t)", "NIL")
CHECK("(or t nil (> 2 1) t)", "T")
CHECK("(or nil (< 2 1) nil)", "NIL")
